...
def predict(X_raw, output_file='predicted_result.csv'):
    ...
    X_raw.to_csv(output_file, index=False)

    print(f"규칙 기반 연체 여부 예측 완료! 결과 파일명: {output_file}")
